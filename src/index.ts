...
type update = Object.Update<User, 'name', {firstName: string, lastName: string}>
...
const withNoInfer = <T>(value: T, getDefault: () => Function.NoInfer<T>) => value;
...
> = {
  ...
  N2 extends Iteration.Pos<Iteration.Prev<I>>
  ? 1
  : 0
];
...
// CLASS
{
type clazz = Class.Class<[name: string, age: number], {name: string, age: number}>;
